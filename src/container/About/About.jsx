      ...
      <div className="container-about" id="about">
        ...
        >
          ...
          <p className="title-text">
            ...
            job opportunity that you want to discuss with me (summer/fall 2023),
            please don't hesitate to contact me. I made this website as a
            complement to my CV so feel free to also check that out. Below are
            some of the technologies and some projects of choice that I've
            worked with.
          </p>
        </motion.div>
      </div>
